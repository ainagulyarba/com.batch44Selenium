...
public class C01_TekrarTesti {
    ...
    public static void main(String[] args) {
        ...
        String actuelTitleYoutube= driver.getTitle();
        String expectedYoutubeTitle="youtube";
        if(actuelTitleYoutube.equals(expectedYoutubeTitle)){
            System.out.println("Youtube title testi PASS");
        }else{
            System.out.println("Youtube title testi FAILED \nActual sayfa basligi : "+actuelTitleYoutube);
        }
        ...
        if(actuelTitleYoutube.contains(arananKelimeYoutubeUrl)){
        ...
        if(actualAmazonTitle.contains(amazonTitleArananKelime)){
            System.out.println("Amazon title PASS");
        }else{
            System.out.println("Amazon title testiFailed \nActual Amazon Title"+ actualAmazonTitle);
        }
